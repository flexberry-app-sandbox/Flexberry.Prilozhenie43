...
namespace IIS.Prilozhenie_43
{
    ...
    public class КартДоступ : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Prilozhenie_43.СправСотр fСправСотр;
        
        private IIS.Prilozhenie_43.DetailArrayOfБазаДанных fБазаДанных;
        ...
        [PropertyStorage(new string[] {
                "СправСотр"})]
        [NotNull()]
        public virtual IIS.Prilozhenie_43.СправСотр СправСотр
        {
            get
            {
                ...
                IIS.Prilozhenie_43.СправСотр result = this.fСправСотр;
        ...
        public virtual IIS.Prilozhenie_43.DetailArrayOfБазаДанных БазаДанных
        {
            get
            {
                ...
                {
                    this.fБазаДанных = new IIS.Prilozhenie_43.DetailArrayOfБазаДанных(this);
                }
                IIS.Prilozhenie_43.DetailArrayOfБазаДанных result = this.fБазаДанных;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View КартДоступE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("КартДоступE", typeof(IIS.Prilozhenie_43.КартДоступ));
                }
            }
            ...
            public static ICSSoft.STORMNET.View КартДоступL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("КартДоступL", typeof(IIS.Prilozhenie_43.КартДоступ));
                }
            }
        }
    }
