...
namespace IIS.Prilozhenie_43
{
    ...
    public class СправУч : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Prilozhenie_43.КлассУч fКлассУч;
        
        private IIS.Prilozhenie_43.СправРод fСправРод;
        ...
        [PropertyStorage(new string[] {
                "КлассУч"})]
        [NotNull()]
        public virtual IIS.Prilozhenie_43.КлассУч КлассУч
        {
            get
            {
                ...
                IIS.Prilozhenie_43.КлассУч result = this.fКлассУч;
        ...
        [PropertyStorage(new string[] {
                "СправРод"})]
        [NotNull()]
        public virtual IIS.Prilozhenie_43.СправРод СправРод
        {
            get
            {
                ...
                IIS.Prilozhenie_43.СправРод result = this.fСправРод;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View СправУчE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СправУчE", typeof(IIS.Prilozhenie_43.СправУч));
                }
            }
            ...
            public static ICSSoft.STORMNET.View СправУчL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СправУчL", typeof(IIS.Prilozhenie_43.СправУч));
                }
            }
        }
    }
