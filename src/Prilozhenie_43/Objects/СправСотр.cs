...
namespace IIS.Prilozhenie_43
{
    ...
    public class СправСотр : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Prilozhenie_43.СправДолж fСправДолж;
        ...
        [PropertyStorage(new string[] {
                "СправДолж"})]
        [NotNull()]
        public virtual IIS.Prilozhenie_43.СправДолж СправДолж
        {
            get
            {
                ...
                IIS.Prilozhenie_43.СправДолж result = this.fСправДолж;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View СправСотрE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СправСотрE", typeof(IIS.Prilozhenie_43.СправСотр));
                }
            }
            ...
            public static ICSSoft.STORMNET.View СправСотрL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СправСотрL", typeof(IIS.Prilozhenie_43.СправСотр));
                }
            }
        }
    }
