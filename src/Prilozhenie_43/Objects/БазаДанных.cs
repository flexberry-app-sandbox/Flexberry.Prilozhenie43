...
namespace IIS.Prilozhenie_43
{
    ...
    public class БазаДанных : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Prilozhenie_43.СправУч fСправУч;
        
        private IIS.Prilozhenie_43.КартДоступ fКартДоступ;
        ...
        [PropertyStorage(new string[] {
                "СправУч"})]
        [NotNull()]
        public virtual IIS.Prilozhenie_43.СправУч СправУч
        {
            get
            {
                ...
                IIS.Prilozhenie_43.СправУч result = this.fСправУч;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Prilozhenie_43.КартДоступ.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "КартДоступ"})]
        public virtual IIS.Prilozhenie_43.КартДоступ КартДоступ
        {
            get
            {
                ...
                IIS.Prilozhenie_43.КартДоступ result = this.fКартДоступ;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View БазаДанныхE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("БазаДанныхE", typeof(IIS.Prilozhenie_43.БазаДанных));
                }
            }
        }
    }
    ...
    public class DetailArrayOfБазаДанных : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Prilozhenie_43.DetailArrayOfБазаДанных members)

        // *** End programmer edit section *** (IIS.Prilozhenie_43.DetailArrayOfБазаДанных members)
        ...
        /// </summary>
        public DetailArrayOfБазаДанных(IIS.Prilozhenie_43.КартДоступ fКартДоступ) : 
                base(typeof(БазаДанных), ((ICSSoft.STORMNET.DataObject)(fКартДоступ)))
        {
        }
        
        public IIS.Prilozhenie_43.БазаДанных this[int index]
        {
            get
            {
                return ((IIS.Prilozhenie_43.БазаДанных)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Prilozhenie_43.БазаДанных dataobject)
        {
